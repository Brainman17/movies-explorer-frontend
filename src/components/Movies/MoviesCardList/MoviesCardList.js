  ...
  return (
    <div className="moviesCardList-wrapper">
        <div className="moviesCardList">
            ...
            <article className="movieCard">
                <img src={movie4} alt="Баския: Взрыв реальности" className="movieCard__image" />
                <div className="movieCard__wrapper">    
            ...
            <article className="movieCard">
                <img src={movie5} alt="Бег это свобода" className="movieCard__image" />
                <div className="movieCard__wrapper">    
            ...
            <article className="movieCard">
                <img src={movie7} alt="Когда я думаю о Германии ночью" className="movieCard__image" />
                <div className="movieCard__wrapper">    
            ...
            <article className="movieCard">
                <img src={movie8} alt="Gimme Danger: История Игги и The Stooges" className="movieCard__image" />
                <div className="movieCard__wrapper">    
                    <p className="movieCard__caption">Gimme Danger: История Игги и The Stooges</p>
                    <time className="movieCard__time">1ч 17м</time>
                </div>
            </article>
            <article className="movieCard">
                <img src={movie9} alt="Дженис: Маленькая девочка грустит" className="movieCard__image" />
                <div className="movieCard__wrapper">    
                    <p className="movieCard__caption">Дженис: Маленькая девочка грустит</p>
                    <time className="movieCard__time">1ч 17м</time>
                </div>
            </article>
            <article className="movieCard">
                <img src={movie10} alt="Соберись перед прыжком" className="movieCard__image" />
                <div className="movieCard__wrapper">    
            ...
            <article className="movieCard">
                <img src={movie11} alt="Пи Джей Харви: A dog called money" className="movieCard__image" />
                <div className="movieCard__wrapper">    
                    <p className="movieCard__caption">Пи Джей Харви: A dog called money</p>
                    <time className="movieCard__time">1ч 17м</time>    
                </div>
            </article>
            <article className="movieCard">
                <img src={movie12} alt="По волнам: Искусство звука в кино" className="movieCard__image" />
                <div className="movieCard__wrapper">
                    <p className="movieCard__caption">По волнам: Искусство звука в кино</p>
                    <time className="movieCard__time">1ч 17м</time>
                </div>
            </article>
        </div>
