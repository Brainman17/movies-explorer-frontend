      ...
      <div className="about-me__wrapper">
        <div className="about-me__small-wrapper">
          ...
          <p className="about-me__text">
            ...
            вместе с&nbsp;моей семьей переехал в&nbsp;Москву. Здесь
            окончил факультет международных отношений РУТ
            по&nbsp;специальности логистика/менеджмент. В&nbsp;свободное время
            мне нравится играть в&nbsp;футбол, на&nbsp;гитаре и&nbsp;кататься
            на&nbsp;сноуборде. С&nbsp;некоторых пор решил погрузиться
